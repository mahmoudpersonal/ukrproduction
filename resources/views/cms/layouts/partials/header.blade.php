        ...
        <!-- Navbar links -->
            ...
            <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                <li class="nav-item dropdown">
                  ...
                  <span class="avatar avatar-sm rounded-circle">{{ auth()->user()->name[0] }}
{{--                    <img alt="Image placeholder" src="{{ asset('img/theme/team-4.jpg') }}">--}}
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form id="frm" action="{{ route('logout') }}" method="post" style="display: none">@csrf</form>
                        <a href="#!" onclick="document.getElementById('frm').submit()" class="dropdown-item">
